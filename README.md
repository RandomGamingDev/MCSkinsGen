...
2. Sign up for a Hugging Face account and then create a read key here: https://huggingface.co/settings/tokens (read is all that's needed, but write works too)
